...
export default function AccountAndBillingPage() {
  const t = useTranslations("dashboard.accountPage");
    ...
    <div className="min-h-screen flex flex-col text-white">
      ...
      <header className="shrink-0 px-4 pt-3 md:px-12 md:pt-20 lg:px-20 max-w-6xl mx-auto w-full">
        <div className="flex flex-col gap-3">
          ...
          <p className="text-sm hg-muted">{t("subtitle")}</p>
        </div>
        ...
        <div className="px-4 md:px-12 lg:px-20 max-w-5xl mx-auto w-full pb-10">
          {loading ? (
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              <div className="lg:col-span-2 space-y-6">
                ...
                >
                  <div className="space-y-1">
                    <p className="text-xs uppercase tracking-wide hg-muted-2">{t("profileEyebrow")}</p>
                  ...
                  {userLoading ? (
                    ...
                    <p className="hg-muted">{t("notSignedIn")}</p>
                  )}
                </Reveal>
                ...
                >
                  <div className="space-y-1">
                    <p className="text-xs uppercase tracking-wide hg-muted-2">{t("securityEyebrow")}</p>
                  ...
                  {userLoading ? (
                    ...
                    <p className="hg-muted">{t("noSecurityActions")}</p>
                  )}
                </Reveal>
              </div>
              ...
              >
                <div className="space-y-1">
                  <p className="text-xs uppercase tracking-wide hg-muted-2">{t("planEyebrow")}</p>
                  <h2 className="text-lg font-semibold">{t("planHeading")}</h2>
                </div>
                <div className="border-t border-[var(--hg-border-2)]" />
                {userPackage ? (
                  <>
                    <div className="grid grid-cols-1 gap-3">
                      <p>
                        <strong>{t("currentPlanLabel")}</strong> {userPackage.name}
                      </p>
                      <p>
                        <strong>{t("uploadsRemainingLabel")}</strong>{" "}
                  ...
                  <>
                    <p className="text-rose-300">{t("noPlanFound")}</p>
                    <div className="pt-1">
                      <Link
                        href="/#packages"
                        className="text-sm font-medium hg-muted hover:text-[#50C0F0] transition"
