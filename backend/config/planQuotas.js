...
const PLAN_QUOTAS = {
  lite:     { uploads: 5,   tokensLimit: 50000,    videos: Number(process.env.SADTALKER_LITE_LIMIT || 10) },
  pro:      { uploads: 20,  tokensLimit: 500000,   videos: Number(process.env.SADTALKER_PRO_LIMIT  || 50) },
  ultimate: { uploads: 100, tokensLimit: 2000000,  videos: 0 },
};
