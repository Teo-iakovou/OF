...
<html>
      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="Child.js.html">Child.js</a></li>
            <li class=""><a href="Children.js.html">Children.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#send"><i class="alert alert-info"></i>send</a>
              </li>
              <li><a href="#spawn"><i class="alert alert-info"></i>spawn</a>
              </li>
              <li><a href="#kill"><i class="alert alert-info"></i>kill</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="send">
            ...
            <p>
              <div class="label label-info radius ctx-type">method</div><span>Child.prototype.send()</span>
            </p>
          </section>
          ...
          <div class="description"><p>Send a message to the child_process</p> </div>
          <pre><code class="language-javascript">Child.prototype.send = function(message){
  ...
  this._process.send(message);
          ...
          <section id="spawn">
            ...
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">method</div><span>Child.prototype.spawn()</span>
            </p>
          </section>
          <div class="description"><p>Spawn a child</p> </div>
          <pre><code class="language-javascript">Child.prototype.spawn = function(fn){
...
Child.prototype.isDead = function(){
  return !this._process || (this._process &amp;&amp; (this._process.killed || !this._process.connected));
          ...
          <section id="kill">
            ...
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">method</div><span>Child.prototype.kill()</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            <thead>
          ...
          <div class="description"><p>Kill the child (it will never be re-used again)</p> </div>
          <pre><code class="language-javascript">Child.prototype.kill = function(fn){
  if(this.isDead()){
    if(fn){_.defer(fn);}
    return this;
  }
