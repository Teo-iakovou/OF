    ...
    <div class="container">
      <div class="row">
        ...
        <div class="span9">
          ...
          <div class="description"><p>Manage child processes</p> </div>
...
Children.prototype._autorespawn = function(child){
  ...
  _.defer(function(){
    ...
    child.spawn(function(){
      this.emit('respawned:child', child, this);
          ...
          <div class="description"><p>Init children, emit "ready" when done</p> </div>
  ...
  return this;
          ...
          <div class="description"><p>Shutdown all workers</p> </div>
...
Children.prototype.send = function(obj){
  this.invoke(&quot;send&quot;, obj);
          ...
          <div class="description"><p>Useful helper for debug</p> </div>
  ...
  return this;
          ...
          <div class="description"><p>Children default options</p> </div>
          <pre><code class="language-javascript">Children.defaults = {</code></pre>
          <div class="description"><p>Number of childs to fork</p> </div>
          <pre><code class="language-javascript">childs: require('os').cpus().length,</code></pre>
          <div class="description"><p>Reset the environment when forking child_processes</p> </div>
          <pre><code class="language-javascript">resetEnv: false,</code></pre>
          <div class="description"><p>Auto-restart dead process</p> </div>
          <pre><code class="language-javascript">autoRestart:true,</code></pre>
          <div class="description"><p>Spawn option</p> </div>
