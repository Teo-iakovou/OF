  ...
  <body data-spy="scroll" data-target=".scrollspy">
    <div class="navbar navbar-inverse navbar-fixed-top">
      <div class="navbar-inner">
        <div class="container"><a class="brand">Node Children</a>
      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class=""><a href="Children.js.html">Children.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
            </ul>
        ...
        <div class="span9">
          <section id="Main"><h1 id="node-children-build-status-https-drone-io-github-com-fgribreau-node-children-status-png-https-drone-io-github-com-fgribreau-node-children-latest-">Node Children <a href="https://drone.io/github.com/FGRibreau/node-children/latest"><img src="https://drone.io/github.com/FGRibreau/node-children/status.png" alt="Build Status"></a></h1>
<p>Concurrent tasks computation among nodejs child processes</p>
<h3 id="features">Features</h3>
<ul>
<li>Evented API (with <a href="https://github.com/hij1nx/EventEmitter2">EventEmitter2</a>)</li>
<li>Auto-respawn dead processes</li>
<li>Underscore methods available on child processes</li>
</ul>
<h2 id="npm">NPM</h2>
<p>Install module with: <code>npm install children</code></p>
<h2 id="-documentation-http-fgribreau-github-com-node-children-docs-index-html-"><a href="http://fgribreau.github.com/node-children/docs/index.html">Documentation</a></h2>
<h2 id="usage">Usage</h2>
<pre><code class="lang-javascript">var children = require(&#39;children&#39;)(path.resolve(__dirname, &#39;./worker2.js&#39;), {
...
<p><code>children</code> is a collection of child process that implements <a href="http://backbonejs.org/#Collection-Underscore-Methods">~28 underscore methods</a></p>
<pre><code class="lang-javascript">&gt; children.pluck(&#39;pid&#39;)
[ 47494, 47495, 47496, 47497 ]</code></pre>
<h2 id="available-events">Available events</h2>
<p><code>ready(children)</code><br><code>respawning:child(child, children)</code><br><code>spawning:child(child, children)</code><br><code>spawned:child(child, children)</code><br><code>killing:child(child, children)</code><br><code>killed:child(child, children, exitCode, signalCode)</code></p>
<h2 id="todo">Todo</h2>
<ul>
...
<p>v0.1.0 - Initial commit (17 fev. 2012)</p>
<h2 id="license">License</h2>
<p>Copyright (c) 2013 Francois-Guillaume Ribreau<br>Licensed under the MIT license.</p>
</section>
        </div>
      </div>
    </div>
