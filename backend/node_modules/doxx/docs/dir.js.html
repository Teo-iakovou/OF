      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="dir.js.html">dir.js</a></li>
            <li class=""><a href="parser.js.html">parser.js</a></li>
            <li class=""><a href="symbols.js.html">symbols.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#collectFiles"><i class="alert alert-info"></i>collectFiles</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="collectFiles">
            <h1>collectFiles</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">function</div><span>collectFiles()</span> -><span>Array</span>
            </p>
          </section>
          ...
          <pre><code class="language-javascript">function collectFiles(source, options) {
