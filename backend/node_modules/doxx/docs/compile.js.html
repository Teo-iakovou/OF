...
<html>
      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="compile.js.html">compile.js</a></li>
          ...
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#compile"><i class="alert alert-info"></i>compile</a>
              </li>
              <li><a href="#code"><i class="alert alert-info"></i>code</a>
              </li>
              <li><a href="#tpl"><i class="alert alert-success"></i>tpl</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="compile">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>compile()</span> -><span>String</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <td>locals</td>
                <td>Object</td>
                <td>local variable object</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>Compile</p> </div>
          <pre><code class="language-javascript">function compile(locals) {
  return jade.compile(compile.tpl, {
    pretty: true
          ...
          <h5>jsFiddle</h5>
          <p>
            <iframe width="100%" height="300" src="http://jsfiddle.net/4L6Br/embedded/" allowfullscreen="allowfullscreen" frameborder="0"></iframe>
          </p>
          <section id="code">
            <h1>code</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">method</div><span>jade.filters.code()</span> -><span>String</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            <thead>
          ...
          <div class="description"><p>Jade support for filter <code>:code</code></p> </div>
          <pre><code class="language-javascript">jade.filters.code = function( block ) {
 return block.replace( /&amp;/g, '&amp;'  )
  ...
  .replace( /\n/g, '\\n'   );
          ...
          <section id="tpl">
            ...
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-success radius ctx-type">property</div><span>compile.tpl</span>
            </p>
          </section>
          <div class="description"><p>Template used to produce the documentation</p> </div>
          <pre><code class="language-javascript">compile.tpl = fs.readFileSync(path.resolve(__dirname, '../views/template.jade')).toString();
