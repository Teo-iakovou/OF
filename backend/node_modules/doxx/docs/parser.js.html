      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="parser.js.html">parser.js</a></li>
            <li class=""><a href="symbols.js.html">symbols.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#shouldPass"><i class="alert alert-info"></i>shouldPass</a>
              </li>
              <li><a href="#has"><i class="alert alert-info"></i>has</a>
              </li>
              <li><a href="#_compact"><i class="alert alert-info"></i>_compact</a>
              </li>
              <li><a href="#parse"><i class="alert alert-info"></i>parse</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="shouldPass">
            <h1>shouldPass</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">function</div><span>shouldPass()</span> -><span>Boolean</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            ...
            <tbody>
              <tr>
                <td>symbol</td>
                <td>Object</td>
                <td>symbol to check against</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>Test if a symbol should be ignored or not</p> </div>
          <pre><code class="language-javascript">function shouldPass(symbol){
  ...
  return symbol.tags.filter(function(tag){
    return tag.type === &quot;private&quot; || tag.type === &quot;ignore&quot;;
          ...
          <section id="has">
            ...
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">function</div><span>has()</span> -><span>Boolean</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            <thead>
          ...
          <div class="description"><p>has Helper return a closure that check if a tag has a specific type</p> </div>
          <pre><code class="language-javascript">function has(val){
  return function(tag){
    return tag.type === val;
  };
}
...
var hasJSFiddle    = has('jsFiddle');</code></pre>
          <section id="_compact">
            <h1>_compact</h1>
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">function</div><span>_compact()</span> -><span>Array</span>
            </p>
          </section>
          <div class="description"><p>Compact multi-line expression</p> </div>
          <pre><code class="language-javascript">function _compact(tags){
  ...
  return compacted;
          ...
          <section id="parse">
            ...
            <h5 class="subheader"></h5>
            <p>
              <div class="label label-info radius ctx-type">function</div><span>parse()</span> -><span>Array</span>
            </p>
          </section>
          <table class="table table-bordered table-striped">
            <thead>
            ...
            <tbody>
              <tr>
                <td>filepath</td>
                <td>String</td>
                <td>file path of the file to parse</td>
              </tr>
            </tbody>
          </table>
          <div class="description"><p>Parse a file and returns a generic format</p> </div>
          <pre><code class="language-javascript">function parse(filepath){
  var json = null;
