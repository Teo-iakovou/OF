      ...
      <div class="row">
        <div class="span3 bs-docs-sidebar">
          <ul class="nav nav-list bs-docs-sidenav affix-top">
            ...
            <li class="active"><a href="symbols.js.html">symbols.js</a></li>
          </ul>
          <div class="scrollspy">
            <ul class="nav nav-list bs-docs-sidenav affix-top">
              <li><a href="#structure"><i class="alert alert-info"></i>structure</a>
              </li>
            </ul>
          </div>
        </div>
        <div class="span9">
          <section id="structure">
            ...
            <p>
              <div class="label label-info radius ctx-type">function</div><span>structure()</span> -><span>Array</span>
            </p>
          </section>
          ...
          <div class="description"><p>Return the structure of a parsed file</p> </div>
          <pre><code class="language-javascript">function structure(symbols, file){
