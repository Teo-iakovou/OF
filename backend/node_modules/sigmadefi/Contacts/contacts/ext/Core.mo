...
module ExtCore = {
  ...
  public type TransferDip721Request = {
    from : User;
    to : User;
    token : TokenIdentifier;
    tokenid: TokenId;
  ...
  public type TransferDip721Response = Result.Result<Balance, {
    #Unauthorized: AccountIdentifier;
    #InsufficientBalance;
    #InvalidToken: TokenIdentifier;
    #Other : Text;
  ...
  public type DIP721Interface = actor {
    transfer : shared (request : TransferDip721Request) -> async TransferDip721Response;
  };
