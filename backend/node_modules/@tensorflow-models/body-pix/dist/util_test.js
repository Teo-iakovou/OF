...
(0, jasmine_util_1.describeWithFlags)('util.toValidInputResolution', jasmine_util_1.ALL_ENVS, function () {
    ...
    it('returns the original value when already a valid resolution', function () {
        var outputStride = 16;
        var validResolution = (0, util_1.toValidInputResolution)(1000, outputStride);
        var resolution = (0, util_1.toValidInputResolution)(validResolution, outputStride);
    ...
    it('succeeds when 1-resolution is divisible by the output stride', function () {
        ...
        var resolution = (0, util_1.toValidInputResolution)(inputResolution, outputStride);
        expect((resolution - 1) % outputStride).toEqual(0);
    });
});
(0, jasmine_util_1.describeWithFlags)('util.toInputResolutionHeightAndWidth', jasmine_util_1.ALL_ENVS, function () {
    function getExpectedResolution(inputShape, outputStride, expectedScalePercentage) {
        return inputShape.map(function (size) { return (0, util_1.toValidInputResolution)(size * expectedScalePercentage, outputStride); });
    }
    it("returns the full image size as a valid input resolution when " +
        ...
        var result = (0, util_1.toInputResolutionHeightAndWidth)(internalResolution, outputStride, inputShape);
