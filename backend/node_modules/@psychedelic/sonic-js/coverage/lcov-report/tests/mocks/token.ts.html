...
<head>
    <title>Code coverage report for tests/mocks/token.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">tests/mocks</a> token.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { SwapIDL, Token } from '@/declarations';
import { parseSupportedTokenList } from 'integrations';
&nbsp;
export const mockToken = <span class="fstat-no" title="function not covered" >({</span>
  decimals,
  fee,
  id,
  name,
  symbol,
  totalSupply,
}: Partial&lt;SwapIDL.TokenInfoExt&gt;): SwapIDL.TokenInfoExt =&gt; (<span class="cstat-no" title="statement not covered" >{</span>
