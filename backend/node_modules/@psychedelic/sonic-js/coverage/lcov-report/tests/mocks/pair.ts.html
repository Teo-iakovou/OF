...
<head>
    <title>Code coverage report for tests/mocks/pair.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="../../index.html">All files</a> / <a href="index.html">tests/mocks</a> pair.ts</h1>
        <div class='clearfix'>
...
<span class="cline-any cline-yes">5x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">import { Pair, SwapIDL } from '@/declarations';
...
export const mockPair = ({
  ...
  token1,
  totalSupply,
}: Partial&lt;Pair.Model&gt; = <span class="branch-0 cbranch-no" title="branch not covered" >{})</span>: Pair.Model =&gt; {
  return {
    id: id || 'token0:token1',
    price0CumulativeLast:
...
&nbsp;</pre></td></tr></table></pre>
            ...
            <div class='footer quiet pad2 space-top1 center small'>
                ...
                at Thu Feb 10 2022 14:38:54 GMT-0300 (Brasilia Standard Time)
            </div>
