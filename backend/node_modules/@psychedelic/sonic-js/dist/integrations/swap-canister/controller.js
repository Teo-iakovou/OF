...
class SwapCanisterController {
     ...
     */
    constructor(swapActor = __1.ActorAdapter.createAnonymousActor(declarations_1.Default.SWAP_CANISTER_ID, declarations_1.SwapIDL.factory)) {
    ...
    async getTokenBalances(principalId) {
        ...
        const tokenBalancePromises = tokens.map((token) => (0, __1.createTokenActor)({ canisterId: token.id })
    ...
    async getTokenBalance({ principalId, tokenId, }) {
        ...
        const tokenBalance = (0, utils_1.toBigNumber)(await tokenActor.balanceOf(principal)).applyDecimals(tokenDecimals);
