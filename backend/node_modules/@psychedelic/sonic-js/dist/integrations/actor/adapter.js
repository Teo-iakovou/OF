...
class ActorAdapter {
    ...
    async createActor(canisterId, interfaceFactory) {
        ...
        let actor;
        if (!this.provider) {
            actor = ActorAdapter.createAnonymousActor(canisterId, interfaceFactory, this.options.host);
        }
        else {
     ...
     */
    static createAnonymousActor(canisterId, interfaceFactory, host = ActorAdapter.DEFAULT_HOST) {
