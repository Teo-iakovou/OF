 ...
 * Type of TokenActor.
 */
export declare type TokenActor = ActorAdapter.Actor<TokenIDL.Token>;
/**
 ...
 */
export declare const createTokenActor: ({ canisterId, actorAdapter, }: CreateTokenActorOptions) => Promise<TokenActor>;
