export declare type VisibilityCache = Map<HTMLElement | undefined, boolean>;
export declare const isVisibleCached: (visibilityCache: Map<HTMLElement | undefined, boolean>, node: HTMLElement | undefined) => boolean;
